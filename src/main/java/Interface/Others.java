...
public class Others extends javax.swing.JFrame {
 ...
 public void tableFill(){    
            ...
            String sql ="Select * FROM products where category='"+others+"'";
            getTable(sql);
    ...
    JOptionPane.showMessageDialog(this, "Error Occurred");
      ...
      public void search(){
        ...
        String others="Other";
        String sql="Select * From products where category = '"+others+"'  and name LIKE '%"+word+"%' ";
         getTable(sql);
     }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 20, 180, 36));

        jPanel5.setBackground(new java.awt.Color(255, 255, 255));
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder("Search"));
        jPanel5.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        productid2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                productid2ActionPerformed(evt);
            }
        });
        jPanel5.add(productid2, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 30, 190, -1));
        ...
        jPanel5.add(search, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 260, -1));

        jPanel1.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 20, 280, -1));
        ...
        setSize(new java.awt.Dimension(854, 647));
    ...
    private void productid2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_productid2ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_productid2ActionPerformed
