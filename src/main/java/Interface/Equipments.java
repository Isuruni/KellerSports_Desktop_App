...
public class Equipments extends javax.swing.JFrame {
    ...
    public Equipments() {
     ...
     public void tableFill(){    
            ...
            String sql ="Select * FROM products where category='"+equipments+"'";
            getTable(sql);
    ...
    JOptionPane.showMessageDialog(this, "Error Occurred");
      ...
      public void search(){
        ...
        String equipments="Equipments";
        String sql="Select * From products where category = '"+equipments+"'  and name LIKE '%"+word+"%' ";
         getTable(sql);
     }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 10, 180, 36));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 10, 280, -1));
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 80, 740, 420));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 850, 600));

        setSize(new java.awt.Dimension(855, 636));
